...
@section('content') 
        ...
        Vue.component('blog-one', {
           ...
           methods: {
             getBlogsOne: function(){
                ...
                var url = '{{ route("blog_one", "province=:province,district=:district,facility=:facility") }}';
        ...
        Vue.component('blog-three', {
           ...
           methods: {
             getBlogsThree: function(){
                ...
                var district = $('#district').val();
                var facility = $('#facility').val();
                var url = '{{ route("blog_metrics_four", "province=:province,district=:district,facility=:facility") }}';
                url = url.replace(':province', province);
                url = url.replace(':district', district);
                url = url.replace(':facility', facility);
                url = url.replace(',', '&');
   ...
   <script>
    ...
    var district = $('#district').val();
    var facility = $('#facility').val();
    var url = '{{ route("pie_metrics_json", "province=:province,district=:district,facility=:facility") }}';
    url = url.replace(':province', province);
    url = url.replace(':district', district);
    url = url.replace(':facility', facility);
    url = url.replace(',', '&');
...
<script type="text/javascript">
  ...
  var district = $('#district').val();
  var facility = $('#facility').val();
  var url = '{{ route("line_metrics_json", "province=:province,district=:district,facility=:facility") }}';
  url = url.replace(':province', province);
  url = url.replace(':district', district);
  url = url.replace(':facility', facility);
  url = url.replace(',', '&');
...
<script type="text/javascript">
  ...
  var district = $('#district').val();
  var facility = $('#facility').val();
  var url = '{{ route("line_metrics_chw_json", "province=:province,district=:district,facility=:facility") }}';
  url = url.replace(':province', province);
  url = url.replace(':district', district);
  url = url.replace(':facility', facility);
  url = url.replace(',', '&');
