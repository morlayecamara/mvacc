...
@section('content') 
        ...
        Vue.component('blog-one', {
           ...
           methods: {
             getBlogsOne: function(){
                ...
                var url = '{{ route("blog_one", "province=:province,district=:district") }}';
        ...
        Vue.component('blog-three', {
           ...
           methods: {
             getBlogsThree: function(){
                var province = $('#province').val();
                var district = $('#district').val();
                var url = '{{ route("blog_metrics_four", "province=:province,district=:district") }}';
                url = url.replace(':province', province);
                url = url.replace(':district', district);
                url = url.replace(',', '&');
   ...
   <script>
    var province = $('#province').val();
    var district = $('#district').val();
    var url = '{{ route("pie_metrics_json", "province=:province,district=:district") }}';
    url = url.replace(':province', province);
    url = url.replace(':district', district);
    url = url.replace(',', '&');
...
<script type="text/javascript">
  var province = $('#province').val();
  var district = $('#district').val();
  var url = '{{ route("line_metrics_json", "province=:province,district=:district") }}';
  url = url.replace(':province', province);
  url = url.replace(':district', district);
  url = url.replace(',', '&');
...
<script type="text/javascript">
  var province = $('#province').val();
  var district = $('#district').val();
  var url = '{{ route("line_metrics_chw_json", "province=:province,district=:district") }}';
  url = url.replace(':province', province);
  url = url.replace(':district', district);
  url = url.replace(',', '&');
  $.getJSON(url, function(data) {
