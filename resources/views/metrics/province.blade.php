...
@section('content') 
        ...
        Vue.component('blog-one', {
           ...
           methods: {
             getBlogsOne: function(){
                ...
                var url = '{{ route("blog_one", "province=:province") }}';
        ...
        Vue.component('blog-three', {
           ...
           methods: {
             getBlogsThree: function(){
                var province = $('#province').val(); 
                var url = '{{ route("blog_metrics_four", "province=:province") }}';
                url = url.replace(':province', province);
   ...
   <script>
    var province = $('#province').val();
    var url = '{{ route("pie_metrics_json", "province=:province") }}';
    url = url.replace(':province', province);
...
<script type="text/javascript">
  var province = $('#province').val();
  var url = '{{ route("line_metrics_json", "province=:province") }}';
  url = url.replace(':province', province);
...
<script type="text/javascript">
  var province = $('#province').val();
  var url = '{{ route("line_metrics_chw_json", "province=:province") }}';
  url = url.replace(':province', province);
  $.getJSON(url, function(data) {
    console.log(data);
     var response = {
