...
@section('content') 
        ...
        Vue.component('blog-one', {
           ...
           methods: {
             getBlogsOne: function(){
                ...
                var zone     = $('#zone').val();
                var url = '{{ route("blog_one", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
        ...
        Vue.component('blog-three', {
           ...
           methods: {
             getBlogsThree: function(){
                ...
                var facility = $('#facility').val();
                var zone     = $('#zone').val();
                var url = '{{ route("blog_metrics_four", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
                url = url.replace(':province', province);
                url = url.replace(':district', district);
                url = url.replace(':facility', facility);
                url = url.replace(':zone', zone);
   ...
   <script>
    ...
    var facility = $('#facility').val();
    var zone     = $('#zone').val();
    var url = '{{ route("pie_metrics_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
    url = url.replace(':province', province);
    url = url.replace(':district', district);
    url = url.replace(':facility', facility);
    url = url.replace(':zone', zone);
...
<script type="text/javascript">
  ...
  var facility = $('#facility').val();
  var zone     = $('#zone').val();
  var url = '{{ route("line_metrics_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
  url = url.replace(':province', province);
  url = url.replace(':district', district);
  url = url.replace(':facility', facility);
  url = url.replace(':zone', zone);
...
<script type="text/javascript">
  ...
  var facility = $('#facility').val();
  var zone     = $('#zone').val();
  var url = '{{ route("line_metrics_chw_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
  url = url.replace(':province', province);
  url = url.replace(':district', district);
  url = url.replace(':facility', facility);
  url = url.replace(':zone', zone);
