  ...
  <style type="text/css">
    ...
    <script type="text/javascript">
              ...
              Vue.component('blog-one', {
                 ...
                 methods: {
                   getBlogsOne: function(){
                     ...
                     var district = $('#district').val();
                     var facility = $('#facility').val();
                     var url = '{{ route("province_blog_one", "province=:province,district=:district,facility=:facility") }}';
            ...
            Vue.component('blog-two', {
               ...
               methods: {
                 getBlogsTwo: function(){
                   ...
                   var district = $('#district').val(); 
                   var facility = $('#facility').val();
                   var url = '{{ route("province_blog_two", "province=:province,district=:district,facility=:facility") }}';
                   url = url.replace(':province', province);
                   url = url.replace(':district', district);
                   url = url.replace(':facility', facility);
                   url = url.replace(',', '&');
            ...
            Vue.component('blog-three', {
               ...
               methods: {
                 getBlogsThree: function(){
                   ...
                   var district = $('#district').val();
                   var facility = $('#facility').val();
                   var url = '{{ route("province_blog_three", "province=:province,district=:district,facility=:facility") }}';
                   url = url.replace(':province', province);
                   url = url.replace(':district', district);
                   url = url.replace(':facility', facility);
                   url = url.replace(',', '&');
              ...
              Vue.component('blog-four', {
                 ...
                 methods: {
                   getBlogsFour: function(){
                     ...
                     var district = $('#district').val();
                     var facility = $('#facility').val();
                     var url = '{{ route("province_blog_four", "province=:province,district=:district,facility=:facility") }}';
                     url = url.replace(':province', province);
                     url = url.replace(':district', district);
                     url = url.replace(':facility', facility);
                     url = url.replace(',', '&');
      ...
      function barfacility(){
        ...
        var url = '{{ route("carte_facility_json", "province=:province,district=:district,facility=:facility") }}';
        url = url.replace(':province', province);
        url = url.replace(':district', district);
        url = url.replace(':facility', facility);
        url = url.replace(',', '&');
        ...
        function pie(){
           ...
           $('#app-chart').append('<chartjs-pie :option="myoption" :labels="mylabels" :datasets="mydatasets"  :width="300" :height="300"></chartjs-pie>');
            ...
            var url = '{{ route("pie_province_json", "province=:province,district=:district,facility=:facility") }}';
            url = url.replace(':province', province);
            url = url.replace(':district', district);
            url = url.replace(':facility', facility);
            url = url.replace(',', '&');
    ...
    var district = $('#district').val();
    var facility = $('#facility').val();
    var url = '{{ route("dropout_province_json", "province=:province,district=:district,facility=:facility") }}';
    url = url.replace(':province', province);
    url = url.replace(':district', district);
    url = url.replace(':facility', facility);
    url = url.replace(',', '&');
    ...
    values = Object.values(dropout);
     ...
     var data = values;
        ...
        bars.append("text")
          ...
          var district = $('#district').val();
          var facility = $('#facility').val();
          var url = '{{ route("bar_province_json", "province=:province,district=:district,facility=:facility") }}';
          url = url.replace(':province', province);
          url = url.replace(':district', district);
          url = url.replace(':facility', facility);
          url = url.replace(',', '&');
