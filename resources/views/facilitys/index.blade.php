...
<style type="text/css">
    #go{ 
     ...
     <link href="../resources/assets/css/jqueryscripttop.css" rel="stylesheet">
      <h1>Performances health facility</h1>
        <div class="row">
           <input id="emailFolder" type="hidden" value="{{ Auth::user()->email }}" name="">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    {
       var addressUrl = domainename+'/blog/public/json/tab/facility/'+emailFolder+'/getData.blade.php';
    }
    else{
       var addressUrl = domainename+'/json/tab/facility/'+emailFolder+'/getData.blade.php';
    }
...
<script type="text/javascript">
  function tab(){
   ...
   if(province == 'all')
   {
      var url = '{{ route("tab_facility_json") }}';
   }
   if(province != 'all' && district == 'all')
   {
      var url = '{{ route("tab_facility_json", "province=:province") }}';
   }
   if(province != 'all' && district != 'all')
   {
     var url = '{{ route("tab_facility_json", "province=:province,district=:district") }}';
   }
