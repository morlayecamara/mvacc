...
@section('content')
                  ...
                  <div class="table-responsive">
                    ...
                    <thead class="thead-default">
                      <tr>
                        ...
                        <th class="text-center">% Coverage pcv</th> 
                    ...
                    <tbody>  
                      <tr v-for="result in results"> 
                        ...
                        <td class="text-center">
                           @{{ result.children_1223-result.nbrpcv }}
                        </td>
                        <td class="text-center">
                           @{{ result.children_1223 }}
                        </td>  
    ...
    <script src="../resources/assets/js/highcharts/zm-all.js"></script> 
     ...
     <script>
      ...
      $.getJSON("{{ route('carte_pcv_json') }}", function(data) {  
        // Create the chart
   ...
   <script>
    $.getJSON("{{ route('pie_pcv_json') }}", function(results){  
    Vue.use(VueCharts);
    const app = new Vue({
        el: '#app-chart',
        data:{
