...
@section('content')
    ...
    <script type="text/javascript">
      ...
      function tab(){
          ...
          var zone = $('#zone').val();
          if(province == 'all'){
            var url = "{{ route('children_community_district_json') }}";
          }
          if(province != 'all' && district == 'all'){ 
            var url = '{{ route("children_community_district_json", "province=:province") }}';
            url = url.replace(':province', province);
          }
          if(province != 'all' && district != 'all' && facility == 'all'){ 
            var url = '{{ route("children_community_district_json", "province=:province,district=:district") }}';
            url = url.replace(':province', province);
            url = url.replace(':district', district);
            url = url.replace(',', '&'); 
          }
          if(province != 'all' && district != 'all' && facility != 'all' && zone == 'all'){ 
            var url = '{{ route("children_community_district_json", "province=:province,district=:district,facility=:facility") }}';
            url = url.replace(':province', province);
            url = url.replace(':district', district);
          ...
          if(province != 'all' && district != 'all' && facility != 'all' && zone != 'all'){ 
            var url = '{{ route("children_community_district_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
            url = url.replace(':province', province);
            url = url.replace(':district', district);
            url = url.replace(':facility', facility);
