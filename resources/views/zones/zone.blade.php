...
@section('content')
  <style type="text/css">
            ...
            <div class="row">
                     @if (Auth::user()->roles == 'admin')
                      ...
                      @if (Auth::user()->roles == 'viewer-zone')
                        ...
                        <input id="district" type="hidden" value="{{ Auth::user()->district }}" name="">
                        <input id="facility" type="hidden" value="{{ Auth::user()->facility }}" name="">
                        <input id="zone" type="hidden" value="{{ Auth::user()->zone }}" name="">
                      @endif
              </div><!--/.row-->
              <div class="row">
    ...
    <script type="text/javascript">
      ...
      $("#name_zone").html('Coverage | Community <span style="color:grey"> ' + zone + ' <small>(Facility: '+facility+')</small></span>');

      $("#name_facility").html('Coverage | Community <span style="color:grey"> ' + zone + ' <small>(Facility: '+facility+' - ' + district+' District)</small></span>');

      $("#name_district").html('Coverage | Community <span style="color:grey"> ' + zone + ' <small>(Facility: '+facility+' - ' + district+' District)</small></span>');
      
      $("#name_province").html('Coverage | Community <span style="color:grey"> ' + zone + ' <small>(Facility: '+facility+' - ' + district+' District)</small></span>');
              ...
              Vue.component('blog-one', {
                 ...
                 methods: {
                   getBlogsOne: function(){
                     ...
                     var facility = $('#facility').val();
                     var zone     = $('#zone').val(); 
                     var url = '{{ route("province_blog_one", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
            ...
            Vue.component('blog-two', {
               ...
               methods: {
                 getBlogsTwo: function(){
                   ...
                   var facility = $('#facility').val(); 
                   var zone     = $('#zone').val(); 
                   var url = '{{ route("province_blog_two", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
                   url = url.replace(':province', province);
                   url = url.replace(':district', district);
                   url = url.replace(':facility', facility);
                   url = url.replace(':zone', zone);
            ...
            Vue.component('blog-three', {
               ...
               methods: {
                 getBlogsThree: function(){
                   ...
                   var facility = $('#facility').val();
                   var zone     = $('#zone').val();
                   var url = '{{ route("province_blog_three", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
                   url = url.replace(':province', province);
                   url = url.replace(':district', district);
                   url = url.replace(':facility', facility);
                   url = url.replace(':zone', zone);
              ...
              Vue.component('blog-four', {
                 ...
                 methods: {
                   getBlogsFour: function(){
                     ...
                     var facility = $('#facility').val();
                     var zone     = $('#zone').val();
                     var url = '{{ route("province_blog_four", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
                     url = url.replace(':province', province);
                     url = url.replace(':district', district);
                     url = url.replace(':facility', facility);
                     url = url.replace(':zone', zone);
      ...
      function barfacility(){
        ...
        var facility = $('#facility').val();
        var zone     = $('#zone').val();
        var url = '{{ route("carte_zone_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
        url = url.replace(':province', province);
        url = url.replace(':district', district);
        url = url.replace(':facility', facility);
        url = url.replace(':zone', zone);
        ...
        function pie(){
           ...
           $('#app-chart').append('<chartjs-pie :option="myoption" :labels="mylabels" :datasets="mydatasets"  :width="300" :height="300"></chartjs-pie>');
            ...
            var facility = $('#facility').val();
            var zone     = $('#zone').val();
            var url = '{{ route("pie_province_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
            url = url.replace(':province', province);
            url = url.replace(':district', district);
            url = url.replace(':facility', facility);
            url = url.replace(':zone', zone);
    ...
    var facility = $('#facility').val();
    var zone     = $('#zone').val();
    var url = '{{ route("dropout_province_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
    url = url.replace(':province', province);
    url = url.replace(':district', district);
    url = url.replace(':facility', facility);
    url = url.replace(':zone', zone);
    ...
    values = Object.values(dropout);
     ...
     var data = values;
        ...
        bars.append("text")
          ...
          var facility = $('#facility').val();
          var zone     = $('#zone').val();
          var url = '{{ route("bar_province_json", "province=:province,district=:district,facility=:facility,zone=:zone") }}';
          url = url.replace(':province', province);
          url = url.replace(':district', district);
          url = url.replace(':facility', facility);
          url = url.replace(':zone', zone);
